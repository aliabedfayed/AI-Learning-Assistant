...
export default function Login() {
    ...
    const loginMutation = useMutation({
        ...
        onSuccess: (res: LoginData) => {
            Cookies.set("userToken", res.token, { expires: 7, path: "/" })
            Cookies.set("user", JSON.stringify(res.user), { expires: 7, path: "/" })
                    ...
                    <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
                        ...
                        <div className="mt-8 pt-6 border-t border-slate-200/60">
                            <p className="text-center text-sm text-slate-600">
                                ...
                                <Link href='/register' className="font-semibold text-emerald-600 hover:text-emerald-700 transition-colors duration-200">
                                    Sign up
                                </Link>
                            </p>
                        </div>
