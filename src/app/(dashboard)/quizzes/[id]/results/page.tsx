...
import { QuizResults, Result } from "@/interfaces/quizzes/quizResult"
...
export default function QuizResult() {
    ...
    const correctAnswers = detailedResults.filter((r: Result) => r.isCorrect).length;
    ...
    return (
        <>
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mb-6">
                    <Link
                        href={`/documents/${quiz.document._id}`}
                ...
                <div className="space-y-6">
                    ...
                    {detailedResults.map((result: Result, index: number) => {
                ...
                <div className="mt-8 flex justify-center">
                    <Link href={`/documents/${quiz.document._id}`}>
