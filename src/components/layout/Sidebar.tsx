...
export default function Sidebar({ isSidebarOpen, toggleSidebar }: SidebarProps) {
    ...
    const sidebarLinks = [
        ...
        { href: "/documents", icon: FileText, text: "Documents" },
        { href: "/flashcards", icon: BookOpen, text: "Flashcards" },
    ...
    return (
        <>
            ...
            >
                ...
                ${isActive ? "bg-linear-to-r from-emerald-500 to-teal-500 text-white shadow-lg" : "text-slate-700 hover:bg-slate-100 hover:text-slate-900"}`}
                            >
                                <link.icon
                                    size={18}
                                    strokeWidth={2.5}
